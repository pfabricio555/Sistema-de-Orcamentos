...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 areaTotal">
            <p style="font-size:14px"><b>Total a pagar:</b> R$ <?php echo $res_1['valor_total'];?></p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <p style="font-size:10px">Orçamento válido até:  <?php echo date('d/m/Y', strtotime("+5 days",strtotime($res_1['data_geracao'])));?></p>
        </div>
    </div>
